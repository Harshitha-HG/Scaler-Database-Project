...
export function UserRow({ row, isTombstoned, onUpdate, onDelete }: UserRowProps) {
  ...
  return (
    <div
      className={`relative rounded-2xl border p-5 transition-all bg-white shadow-sm hover:shadow-md ${
        isTombstoned
      ...
      <div className="grid grid-cols-[1fr_2fr_2fr_auto] gap-4 items-center">
        ...
        <div>
          ...
          <input
            ...
            className={`w-full border rounded-xl px-3 py-2 text-sm transition-all focus:outline-none focus:ring-2 ${
              hasNameChanges 
          ...
          {isTombstoned ? (
            ...
            <>
              <button
                ...
                className="p-2 rounded-xl bg-slate-100 text-slate-500 hover:text-slate-700 hover:bg-slate-200 transition-colors shadow-sm"
